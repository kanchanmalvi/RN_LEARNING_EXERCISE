...
const Props = ({headingText, ImgSrc}) => {
  ...
  return (
    <View>
      ...
      <Button title="linking page" onPress={Navigate} />
          ...
          return (
            <View>
              <View style={styles.box}>
                ...
                <Text style={styles.isemployeStyle}>
                  {elements.item.IsEmploye}
                </Text>
                <Text style={styles.dateStyle}>
                  {elements.item.joiningDate}
                </Text>
              </View>
            </View>
          );
      ...
      <View>
        <Button
          ...
          title="00"
          onPress={Counter_plusClick}
        />

        <Text style={styles.ButtonStyle} onPress={() => setCount(0)}>
          Number - {Count}
        </Text>
